    ...
    return (
        <section className="bg-violet-950 p-6 rounded-lg max-w-[420px] mx-auto">
            <form onSubmit={handleLogin} className="flex flex-col items-start justify-around min-h-[30vh]">
                ...
                <input type="submit" value="Login" className="bg-emerald-400 text-violet-950 py-2 px-8
            ...
            <button onClick={handleGoogle}className="bg-emerald-400 text-violet-950 py-2 px-8
                 rounded-lg shadow-lg transition duration-300 hover:bg-blue-400 cursor-pointer" > Login with Google </button>
        </section>
    )
}